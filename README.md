...
- [User Menu Mastery: Enhancing Taste, Boosting Revenue](https://github.com/anmolvir-kaur/TasteoftheWorldCafeMenuAnalysis/blob/main/README.md) Revamping Taste of the World Cafe: With SQL, this project refines the menu, improves operations, and increases revenue by analyzing customer preferences, order timings, and high-spending patterns. **Top five techniques used in this project: Conditional Logic (CASE WHEN), Table Joins (Combining Tables), Subqueries, View Creation, & Sorting and Ordering (ORDER BY)**
